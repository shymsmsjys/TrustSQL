...
trusted_ordered_def:
		opt_constraint TRUSTED_SYM ORDER_SYM '(' ident ')' 
		{
			CLOG_TPRINTLN("yacc:trusted_ordered_def-> opt_constraint TRUSTED_SYM ORDER_SYM '(' ident ')' ");			
			Lex->lex_sig_field_info = new (thd->mem_root) LEX_sig_field_info();
			Lex->lex_sig_field_info->set_order_column_name(&$1,&$5);
		}
		SIGNATURE_SYM '(' ident ')' 
		{
			Lex->lex_sig_field_info->set_sig_name(&$10);
		}
		;
