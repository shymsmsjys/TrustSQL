...
int my_sync(File fd, myf my_flags)
{
  ...
  CLOG_FUNCTIOND("int my_sync(File fd, myf my_flags)");
                ...
                myf my_flags __attribute__((unused)))
{
  ...
  CLOG_TPRINTLN("int my_sync_dir(const char *dir_name __attribute__((unused))...");
  CLOG_TPRINTLN("my - Dir: '%s'  my_flags: %lu", dir_name, my_flags);
