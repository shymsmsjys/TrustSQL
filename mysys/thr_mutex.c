...
void my_mutex_init()
{
  ...
  CLOG_FUNCTIOND("void my_mutex_init()");
#ifdef PTHREAD_ADAPTIVE_MUTEX_INITIALIZER_NP
  /*
    ...
    short).
  */
  CLOG_STEP("1","Set mutex type to fast a.k.a adaptive");
  ...
  */
  CLOG_STEP("2","Set mutex type to fast a.k.a adaptive");
