                 ...
                 MARIA_CREATE_INFO *ci,uint flags)
{
  ...
  CLOG_FUNCTIOND("int maria_create(const char *name, enum data_file_type datafile_type,...)");
  CLOG_TPRINTLN("enter - keys: %u  columns: %u  uniques: %u  flags: %u", keys, columns, uniques, flags);
