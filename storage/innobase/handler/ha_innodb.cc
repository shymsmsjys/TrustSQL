...
ha_innobase::open(const char* name, int, uint)
{
	...
	CLOG_FUNCTIONDI("ha_innobase::open(const char* name, int, uint)");
	...
	uchar*	record)	/*!< in: a row in MySQL format */
{
	...
	CLOG_FUNCTIONDI("int ha_innobase::write_row(..)");
    CLOG_TPRINTLN(" record = ");
	CLOG_DISPSTR(record);
	...
	trx_t*		trx)
{
	...
	CLOG_FUNCTIONDI("inline int ha_innobase::create(const char* name,...");
	...
	my_bool		discard)	/*!< in: TRUE if discard, else import */
{
	...
	CLOG_FUNCTIONDI("int ha_innobase::discard_or_import_tablespace(..)");
...
inline int ha_innobase::delete_table(const char* name, enum_sql_command sqlcom)
{
	...
	CLOG_FUNCTIONDI("inline int ha_innobase::delete_table(const char* name, enum_sql_command sqlcom)");
	...
	bool		commit = true)
{
	...
	CLOG_FUNCTIONDI("inline dberr_t innobase_rename_table(...)");
...
int ha_innobase::truncate()
{
	...
	CLOG_FUNCTIONDI("int ha_innobase::truncate()");
	...
	const char*	to)	/*!< in: new name of the table */
{
	...
	CLOG_FUNCTIONDI("int ha_innobase::rename_table(..)");
						...
						also be 0 */
{
	...
	CLOG_FUNCTIONDI("ha_rows ha_innobase::records_in_range(..)");
...
/*====================================*/
{
	...
	CLOG_FUNCTIONDI("ha_rows ha_innobase::estimate_rows_upper_bound()");
	...
	bool	is_analyze)
{
	...
	DBUG_ENTER("info");
	CLOG_FUNCTIONDI("int ha_innobase::info_low(...)");
	...
	HA_CHECK_OPT*	check_opt)	/*!< in: check options */
{
	...
	CLOG_FUNCTIONDI("int ha_innobase::check(..)");
...
/*==========================================*/
{
	...
	CLOG_FUNCTIONDI("char* ha_innobase::get_foreign_key_create_info(void)");
	CLOG_TPRINTLN("Gets the foreign key create info for a table stored in InnoDB");
	...
	*/
	...
	CLOG_TPRINTLN("foreing key info from InnoDB = %s",fk_str);
	...
	thr_lock_type	lock_type)
{
	...
	CLOG_FUNCTIONDI("int ha_innobase::start_stmt(..)");
	...
	int	lock_type)	/*!< in: lock type */
{
	...
	CLOG_FUNCTIONDI("int ha_innobase::external_lock(..)");
	...
	stat_print_fn*	stat_print)
{
	...
	CLOG_FUNCTIONDI("static int innodb_show_status(...)");
	...
	stat_print_fn*	stat_print)
{
	...
	CLOG_FUNCTIONDI("static int innodb_show_mutex_status(...)");
	...
	ibool signal)
{
	...
	CLOG_FUNCTIONDI("wsrep_innobase_kill_one_trx");
	...
	my_bool signal)
{
	...
	CLOG_FUNCTIONDI("static int wsrep_abort_transaction(..)");
